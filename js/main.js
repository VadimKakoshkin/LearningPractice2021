...
const appData = {
  ...
  logger: function () {
    ...
    console.log("Стоимость верстки экранов " + appData.screenPrice + " юаней и стоимость разработки сайта " + appData.fullPrice + " юаней.");
    console.log("Значения данных в appData:");
    console.log(" ");
...
let buttonTiming = document.querySelector('.screen-btn');
...
let span = document.querySelector('.rollback .range-value');
